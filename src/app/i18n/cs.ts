...
export const cs: Dict = {
  ...
  signin: {
    ...
    phoneStepTitle: "Telefonní číslo",
    phoneStepDesc: "Zadej svoje telefonní číslo, ať tě můžeme v případě potřeby kontaktovat.",
    countryPlaceholder: "Vyber zemi",
    searchCountryPlaceholder: "Hledat zemi...",
    phonePlaceholder: "Telefonní číslo",
    nextBtn: "Pokračovat",
    phoneRequiredError: "Telefonní číslo je povinné",
    birthDateRequiredError: "Datum narození je povinné",
    fillFieldsError: "Vyplň prosím všechna pole",
    invalidEmailError: "Zadej platnou emailovou adresu",
    passwordTooShortError: "Heslo musí mít alespoň 6 znaků",
    passwordMismatchError: "Hesla se neshodují",
    birthDatePlaceholder: "DD/MM/RRRR",
    confirmEmailTitle: "Zkontroluj svůj email",
    confirmEmailDesc: (email) => `Poslali jsme potvrzovací odkaz na ${email}. Klikni na něj a dokonči registraci.`,
