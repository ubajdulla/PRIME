...
export const ru: Dict = {
  ...
  signin: {
    ...
    phoneStepDesc: "Введи номер телефона, чтобы мы могли с тобой связаться.",
    ...
    confirmEmailDesc: (email) => `Мы отправили ссылку для подтверждения на ${email}. Перейди по ней, чтобы завершить регистрацию.`,
