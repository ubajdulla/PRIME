...
export const en: Dict = {
  ...
  signin: {
    ...
    phoneStepDesc: "Enter your phone number so we can reach you if needed.",
    ...
    confirmEmailDesc: (email) => `We've sent a confirmation link to ${email}. Click it to finish creating your account.`,
