...
export function SelectField<T extends string>({
  ...
  const opts = options.map(o => (typeof o === "string" ? { value: o, label: o as string } : o));
          ...
          <DropdownPanel scrollable>
            {opts.map(o => (
              <button
                ...
                className={`block w-full px-4 py-2.5 text-sm font-semibold text-left transition-colors focus:outline-none ${
